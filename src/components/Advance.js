...
import Image1 from '../assets/images/Amon.png';
import Image2 from '../assets/images/Atue.png';
import Image3 from '../assets/images/Awed.png';
import Image4 from '../assets/images/Athu.png';
import Image5 from '../assets/images/Afri.png';
            ...
            <Box mt={8} display="flex" justifyContent="center">
                <Grid container spacing={3} alignItems="flex-start" ml={10}>
                    <Grid item xs={6} >
                        ...
                        <Typography variant="body1" align="left">Monday: Shoulders and Abs Workout</Typography>
                        <Typography variant="body1" align="left">Tuesday: Arms and Abs Workout</Typography>
                        <Typography variant="body1" align="left">Wednesday: Legs and Abs Workout</Typography>
                        <Typography variant="body1" align="left">Thursday: Back and Abs Workout</Typography>
                        <Typography variant="body1" align="left">Friday: Chest and Abs Workout</Typography>
                        <Typography variant="body1" align="left">Saturday: Simple Cardio and Stretching </Typography>
                    ...
                    <Grid item xs={5}>
                        ...
                        <Typography variant="body1" align="left">Training Level: Advanced</Typography>
